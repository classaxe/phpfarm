    ...
    for i in "${config_php[@]}"; do
        ...
        if [ ${phpv:0:1} == 5 ]; then
            ...
            if [ ! -f /opt/phpfarm/inst/php-${phpv}/etc/php-fpm.conf ]; then
                cp /opt/phpfarm/files/php-fpm-xxx.conf    /opt/phpfarm/inst/php-${phpv}/etc/php-fpm.conf
                ...
                sed -i "s/###web_user###/${web_user}/g"   /opt/phpfarm/inst/php-${phpv}/etc/php-fpm.conf
                sed -i "s/###web_group###/${web_group}/g" /opt/phpfarm/inst/php-${phpv}/etc/php-fpm.conf
            fi
        else
            ...
            if [ ! -f /opt/phpfarm/inst/php-${phpv}/etc/php-fpm.d/www.conf ]; then
                cp /opt/phpfarm/files/php-fpm-xxx.conf    /opt/phpfarm/inst/php-${phpv}/etc/php-fpm.d/www.conf
                ...
                sed -i "s/###web_user###/${web_user}/g"   /opt/phpfarm/inst/php-${phpv}/etc/php-fpm.d/www.conf
                sed -i "s/###web_group###/${web_group}/g" /opt/phpfarm/inst/php-${phpv}/etc/php-fpm.d/www.conf
            fi
        fi
        if [ ! -f /etc/init.d/php-${phpn} ]; then
            cp /opt/phpfarm/files/php-init.d-xxx.sh /etc/init.d/php-${phpn}
